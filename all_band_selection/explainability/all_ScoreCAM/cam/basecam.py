...
import torch
from utils import find_cnn1d_layer
...
class BaseCAM(object):
    ...
    def __init__(self, model_dict):
        ...
        if 'cnn1d' in model_type.lower():
            self.target_layer = find_cnn1d_layer(self.model_arch, layer_name)
        else:
            print(f"[Errore] Tipo di modello '{model_type}' non supportato. Attualmente supportiamo solo 'cnn1d'.")
